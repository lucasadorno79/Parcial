...
class RegistroepDao:
    ...
    def getRegistroep(self):
        ...
        try:
            ...
            app.logger.error(f"Error al obtener todos las registros: {str(e)}")
            return []
    ...
    def guardarRegistroep(self, nombre, color, categoria):
        insertRegistroepSQL = """
        ...
        try:
            cur.execute(insertRegistroepSQL, ( nombre, color, categoria))
    ...
    def updateRegistroep(self, id,  nombre, color, categoria):
        updateRegistroepSQL = """
        UPDATE productos
        ...
        try:
            cur.execute(updateRegistroepSQL, (nombre, color, categoria, id))
    ...
    def deleteRegistroep(self, id):
        ...
        try:
            cur.execute(deleteRegistroepSQL, (id,))
